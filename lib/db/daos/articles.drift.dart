...
mixin $ArticlesDaoMixin on i0.DatabaseAccessor<i1.DB> {
  i2.Articles get articles => i3.ReadDatabaseContainer(
    attachedDatabase,
  ...
  i2.ArticlesFts get articlesFts => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i2.ArticlesFts>('articles_fts');
  i2.ArticleDrift get articleDrift => i3.ReadDatabaseContainer(
    attachedDatabase,
